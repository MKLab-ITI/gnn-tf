...
from core.nn.layers import Dense
...
class APPNP(GNN):
    ...
    def __init__(self, G: tf.Tensor, features: tf.Tensor, num_classes: int, a: float = 0.1, latent_dims=[64], iterations=10, dropout = 0.6, graph_dropout=0.5, **kwargs):
        ...
        for _ in range(iterations):
            self.add(PPRIteration(H0, a, graph_dropout=graph_dropout))